...
<qgis version="2.10.1-Pisa" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="geoid2">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="white">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="black">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="asian">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="hispanic">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="hispanic" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor">
    <ranges>
      <range render="true" symbol="0" lower="0.000000" upper="200.000000" label=" 0 - 200 "/>
      <range render="true" symbol="1" lower="200.000000" upper="400.000000" label=" 200 - 400 "/>
      <range render="true" symbol="2" lower="400.000000" upper="600.000000" label=" 400 - 600 "/>
      <range render="true" symbol="3" lower="600.000000" upper="800.000000" label=" 600 - 800 "/>
      <range render="true" symbol="4" lower="800.000000" upper="1000.000000" label=" 800 - 1000 "/>
      <range render="true" symbol="5" lower="1000.000000" upper="1200.000000" label=" 1000 - 1200 "/>
      <range render="true" symbol="6" lower="1200.000000" upper="1298.000000" label=" 1200 - 1298 "/>
    </ranges>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="217,217,205,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
